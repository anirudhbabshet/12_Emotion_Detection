...
def load_data(filepath='datasets\speech-emotion-recognition-ravdess-data\Actor_*', test_size = 0.2):
  x, y = [], []
...
#t = extract_feature(os.path.join("datasets\\speech-emotion-recognition-ravdess-data\\speech-emotion-recognition-ravdess-data", "Actor_24", "03-01-06-02-02-02-24.wav"), mfcc=True, chroma=True, mel=True)
